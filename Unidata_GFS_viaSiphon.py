...
def addcolorbar():
    ...
    cbar = plt.colorbar(im, cax=cax, ticks=clevs, extend='both', orientation='vertical')
...
"""
ymdh = '2020061906'  # YYYYMMDDHH; change to a command-line input with the line ymdh = sys.argv[1]
